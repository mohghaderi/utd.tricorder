...
Implements WebRTC cinitiateOfferonnectivity for sharing video
...
WebRtcApp.ConnectionManager = (function () {
    var _signaler,
        ...
        // list from https://github.com/stephenlb/webrtc-sdk/blob/gh-pages/js/webrtc.js
        //_iceServers = [{
        //"url":
        //    navigator.mozGetUserMedia ? "stun:stun.services.mozilla.com" :
        //    navigator.webkitGetUserMedia ? "stun:74.125.142.127:19302" : // stun.l.google.com - Firefox does not support DNS names.
        //                                   "stun:23.21.150.121"
        //    },
        ...
        _receivedSdpSignal = function (connection, partnerClientId, sdp) {
            ...
            }, function (e) { console.log("setRemoteDescription" + e); });
        },
        ...
        _initiateOffer = function (partnerClientId, stream) {
            ...
            connection.createOffer(function (desc) {
                connection.setLocalDescription(desc, function () {
                    _signaler.sendSignal(JSON.stringify({ "sdp": connection.localDescription }), partnerClientId);
                }, function (error) { console.log('Error creating local description: ' + error); });
            }, function (error) { console.log('Error creating session description: ' + error); });
        };
