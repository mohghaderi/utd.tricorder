...
namespace UTD.Tricorder.Common.Factories
{
    /// <summary>
    ...
    internal class ProjectEntityFactory : IEntityFactory
    {
        ...
        {
            ApplicationSetting appSetting = FWUtils.ConfigUtils.GetAppSettings();
            IServiceBase obj = (IServiceBase)FWUtils.ReflectionUtils.CreateInstance(appSetting.Project.NamespacePrefix + ".Service", entityName + "Service", appSetting.Project.NamespacePrefix + ".Service", null);
        ...
        {
            ApplicationSetting appSetting = FWUtils.ConfigUtils.GetAppSettings();
            IBusinessRuleBase obj = (IBusinessRuleBase)FWUtils.ReflectionUtils.CreateInstance(appSetting.Project.NamespacePrefix + ".BusinessRule", entityName + "BR", appSetting.Project.NamespacePrefix + ".BusinessRule", null);
            obj.Initialize(entityName, additionalDataKey);
            return obj;
        }
