...
{
	public class TicketStatusEN : EntityInfoBase
	{
		...
		public override void Initialize(string entityName, string additionalDataKey)
        {
            base.Initialize(entityName, additionalDataKey);
				...
				this.EntityColumns.Add(vTicketStatus.ColumnNames.TicketStatusID,
                new ColumnInfo() { 
								Name= vTicketStatus.ColumnNames.TicketStatusID,
								Caption=new i18nText("Common.ENInfo.TicketStatus.TicketStatusID.Caption", "Ticket Status"),
				...
				this.EntityColumns.Add(vTicketStatus.ColumnNames.TicketStatusCode,
                new ColumnInfo() { 
								Name= vTicketStatus.ColumnNames.TicketStatusCode,
								Caption=new i18nText("Common.ENInfo.TicketStatus.TicketStatusCode.Caption", "Ticket Status Code"),
				...
				this.EntityColumns.Add(vTicketStatus.ColumnNames.TicketStatusTitle,
                new ColumnInfo() { 
								Name= vTicketStatus.ColumnNames.TicketStatusTitle,
								Caption=new i18nText("Common.ENInfo.TicketStatus.TicketStatusTitle.Caption", "Ticket Status Title"),
								DataTypeDotNet=typeof(string), 
            ...
            this.EntityTitle = "Ticket Status";
            this.IDFieldName = "TicketStatusID";
            this.CodeFieldName = "TicketStatusCode";
            this.TitleFieldName = "TicketStatusTitle";
		...
		public static ITicketStatusService GetService(string additionalDataKey = "")
		{
			return (ITicketStatusService) EntityFactory.GetEntityServiceByName(vTicketStatus.EntityName, additionalDataKey);
		}
		...
		public static TicketStatus GetEntityObjectT()
		{
			return (TicketStatus)EntityFactory.GetEntityObject(vTicketStatus.EntityName, GetSourceTypeEnum.Table);
		}
        ...
        /// </summary>
        /// <returns>Entity object</returns>
		public static vTicketStatus GetEntityObjectV()
		{
			return (vTicketStatus)EntityFactory.GetEntityObject(vTicketStatus.EntityName, GetSourceTypeEnum.View);
		}
