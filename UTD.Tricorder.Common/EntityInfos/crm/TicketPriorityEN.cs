...
{
	public class TicketPriorityEN : EntityInfoBase
	{
		...
		public override void Initialize(string entityName, string additionalDataKey)
        {
            base.Initialize(entityName, additionalDataKey);
				...
				this.EntityColumns.Add(vTicketPriority.ColumnNames.TicketPriorityID,
                new ColumnInfo() { 
								Name= vTicketPriority.ColumnNames.TicketPriorityID,
								Caption=new i18nText("Common.ENInfo.TicketPriority.TicketPriorityID.Caption", "Ticket Priority"),
				...
				this.EntityColumns.Add(vTicketPriority.ColumnNames.TicketPriorityTitle,
                new ColumnInfo() { 
								Name= vTicketPriority.ColumnNames.TicketPriorityTitle,
								Caption=new i18nText("Common.ENInfo.TicketPriority.TicketPriorityTitle.Caption", "Ticket Priority Title"),
				...
				this.EntityColumns.Add(vTicketPriority.ColumnNames.TicketPriorityCode,
                new ColumnInfo() { 
								Name= vTicketPriority.ColumnNames.TicketPriorityCode,
								Caption=new i18nText("Common.ENInfo.TicketPriority.TicketPriorityCode.Caption", "Ticket Priority Code"),
								DataTypeDotNet=typeof(string), 
            ...
            this.EntityTitle = "Ticket Priority";
            this.IDFieldName = "TicketPriorityID";
            this.CodeFieldName = "TicketPriorityCode";
            this.TitleFieldName = "TicketPriorityTitle";
		...
		public static ITicketPriorityService GetService(string additionalDataKey = "")
		{
			return (ITicketPriorityService) EntityFactory.GetEntityServiceByName(vTicketPriority.EntityName, additionalDataKey);
		}
		...
		public static TicketPriority GetEntityObjectT()
		{
			return (TicketPriority)EntityFactory.GetEntityObject(vTicketPriority.EntityName, GetSourceTypeEnum.Table);
		}
        ...
        /// </summary>
        /// <returns>Entity object</returns>
		public static vTicketPriority GetEntityObjectV()
		{
			return (vTicketPriority)EntityFactory.GetEntityObject(vTicketPriority.EntityName, GetSourceTypeEnum.View);
		}
