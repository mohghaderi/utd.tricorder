...
{
	public class FoodEN : EntityInfoBase
	{
		...
		public override void Initialize(string entityName, string additionalDataKey)
        {
            base.Initialize(entityName, additionalDataKey);
				...
				this.EntityColumns.Add(vFood.ColumnNames.FoodID,
                new ColumnInfo() { 
								Name= vFood.ColumnNames.FoodID,
								Caption=new i18nText("Common.ENInfo.Food.FoodID.Caption", "Food"),
				...
				this.EntityColumns.Add(vFood.ColumnNames.FoodCode,
                new ColumnInfo() { 
								Name= vFood.ColumnNames.FoodCode,
								Caption=new i18nText("Common.ENInfo.Food.FoodCode.Caption", "Food Code"),
				...
				this.EntityColumns.Add(vFood.ColumnNames.FoodTitle,
                new ColumnInfo() { 
								Name= vFood.ColumnNames.FoodTitle,
								Caption=new i18nText("Common.ENInfo.Food.FoodTitle.Caption", "Food Title"),
								DataTypeDotNet=typeof(string), 
				...
				this.EntityColumns.Add(vFood.ColumnNames.FoodCaloriePer100g,
                new ColumnInfo() { 
								Name= vFood.ColumnNames.FoodCaloriePer100g,
								Caption=new i18nText("Common.ENInfo.Food.FoodCaloriePer100g.Caption", "Food Calorie Per100g"),
            ...
            this.EntityTitle = "Food";
            this.IDFieldName = "FoodID";
            this.CodeFieldName = "FoodCode";
            this.TitleFieldName = "FoodTitle";
		...
		public static IFoodService GetService(string additionalDataKey = "")
		{
			return (IFoodService) EntityFactory.GetEntityServiceByName(vFood.EntityName, additionalDataKey);
		}
		...
		public static Food GetEntityObjectT()
		{
			return (Food)EntityFactory.GetEntityObject(vFood.EntityName, GetSourceTypeEnum.Table);
		}
        ...
        /// </summary>
        /// <returns>Entity object</returns>
		public static vFood GetEntityObjectV()
		{
			return (vFood)EntityFactory.GetEntityObject(vFood.EntityName, GetSourceTypeEnum.View);
		}
