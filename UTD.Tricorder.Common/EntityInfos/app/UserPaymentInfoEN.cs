...
{
	public class UserPaymentInfoEN : EntityInfoBase
	{
		...
		public override void Initialize(string entityName, string additionalDataKey)
        {
            base.Initialize(entityName, additionalDataKey);
				...
				this.EntityColumns.Add(vUserPaymentInfo.ColumnNames.UserPaymentInfoID,
                new ColumnInfo() { 
								Name= vUserPaymentInfo.ColumnNames.UserPaymentInfoID,
								Caption=new i18nText("Common.ENInfo.UserPaymentInfo.UserPaymentInfoID.Caption", "User Payment Info"),
				...
				this.EntityColumns.Add(vUserPaymentInfo.ColumnNames.UserPaymentInfoPayPalEmail,
                new ColumnInfo() { 
								Name= vUserPaymentInfo.ColumnNames.UserPaymentInfoPayPalEmail,
								Caption=new i18nText("Common.ENInfo.UserPaymentInfo.UserPaymentInfoPayPalEmail.Caption", "User Payment Info Pay Pal Email"),
								DataTypeDotNet=typeof(string), 
								ValidationMaxLength= 170,
				...
				this.EntityColumns.Add(vUserPaymentInfo.ColumnNames.Notes,
                new ColumnInfo() { 
								Name= vUserPaymentInfo.ColumnNames.Notes,
								Caption=new i18nText("Common.ENInfo.UserPaymentInfo.Notes.Caption", "Notes"),
								DataTypeDotNet=typeof(string), 
            ...
            this.EntityTitle = "User Payment Info";
            this.IDFieldName = "UserPaymentInfoID";
            this.CodeFieldName = "";
            this.TitleFieldName = "";
		...
		public static IUserPaymentInfoService GetService(string additionalDataKey = "")
		{
			return (IUserPaymentInfoService) EntityFactory.GetEntityServiceByName(vUserPaymentInfo.EntityName, additionalDataKey);
		}
		...
		public static UserPaymentInfo GetEntityObjectT()
		{
			return (UserPaymentInfo)EntityFactory.GetEntityObject(vUserPaymentInfo.EntityName, GetSourceTypeEnum.Table);
		}
        ...
        /// </summary>
        /// <returns>Entity object</returns>
		public static vUserPaymentInfo GetEntityObjectV()
		{
			return (vUserPaymentInfo)EntityFactory.GetEntityObject(vUserPaymentInfo.EntityName, GetSourceTypeEnum.View);
		}
