...
{
	public class FitActivityCategoryEN : EntityInfoBase
	{
		...
		public override void Initialize(string entityName, string additionalDataKey)
        {
            base.Initialize(entityName, additionalDataKey);
				...
				this.EntityColumns.Add(vFitActivityCategory.ColumnNames.FitActivityCategoryID,
                new ColumnInfo() { 
								Name= vFitActivityCategory.ColumnNames.FitActivityCategoryID,
								Caption=new i18nText("Common.ENInfo.FitActivityCategory.FitActivityCategoryID.Caption", "Fit Activity Category"),
				...
				this.EntityColumns.Add(vFitActivityCategory.ColumnNames.FitActivityCategoryTitle,
                new ColumnInfo() { 
								Name= vFitActivityCategory.ColumnNames.FitActivityCategoryTitle,
								Caption=new i18nText("Common.ENInfo.FitActivityCategory.FitActivityCategoryTitle.Caption", "Fit Activity Category Title"),
            ...
            this.EntityTitle = "Fit Activity Category";
            this.IDFieldName = "FitActivityCategoryID";
            this.CodeFieldName = "";
            this.TitleFieldName = "FitActivityCategoryTitle";
		...
		public static IFitActivityCategoryService GetService(string additionalDataKey = "")
		{
			return (IFitActivityCategoryService) EntityFactory.GetEntityServiceByName(vFitActivityCategory.EntityName, additionalDataKey);
		}
		...
		public static FitActivityCategory GetEntityObjectT()
		{
			return (FitActivityCategory)EntityFactory.GetEntityObject(vFitActivityCategory.EntityName, GetSourceTypeEnum.Table);
		}
        ...
        /// </summary>
        /// <returns>Entity object</returns>
		public static vFitActivityCategory GetEntityObjectV()
		{
			return (vFitActivityCategory)EntityFactory.GetEntityObject(vFitActivityCategory.EntityName, GetSourceTypeEnum.View);
		}
