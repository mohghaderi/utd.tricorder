...
{
	public class FoodServingTypeEN : EntityInfoBase
	{
		...
		public override void Initialize(string entityName, string additionalDataKey)
        {
            base.Initialize(entityName, additionalDataKey);
				...
				this.EntityColumns.Add(vFoodServingType.ColumnNames.FoodServingTypeID,
                new ColumnInfo() { 
								Name= vFoodServingType.ColumnNames.FoodServingTypeID,
								Caption=new i18nText("Common.ENInfo.FoodServingType.FoodServingTypeID.Caption", "Food Serving Type"),
				...
				this.EntityColumns.Add(vFoodServingType.ColumnNames.FoodServingTypeTitle,
                new ColumnInfo() { 
								Name= vFoodServingType.ColumnNames.FoodServingTypeTitle,
								Caption=new i18nText("Common.ENInfo.FoodServingType.FoodServingTypeTitle.Caption", "Food Serving Type Title"),
				...
				this.EntityColumns.Add(vFoodServingType.ColumnNames.FoodServingTypeCalorieUnit,
                new ColumnInfo() { 
								Name= vFoodServingType.ColumnNames.FoodServingTypeCalorieUnit,
								Caption=new i18nText("Common.ENInfo.FoodServingType.FoodServingTypeCalorieUnit.Caption", "Food Serving Type Calorie Unit"),
            ...
            this.EntityTitle = "Food Serving Type";
            this.IDFieldName = "FoodServingTypeID";
            this.CodeFieldName = "";
            this.TitleFieldName = "FoodServingTypeTitle";
		...
		public static IFoodServingTypeService GetService(string additionalDataKey = "")
		{
			return (IFoodServingTypeService) EntityFactory.GetEntityServiceByName(vFoodServingType.EntityName, additionalDataKey);
		}
		...
		public static FoodServingType GetEntityObjectT()
		{
			return (FoodServingType)EntityFactory.GetEntityObject(vFoodServingType.EntityName, GetSourceTypeEnum.Table);
		}
        ...
        /// </summary>
        /// <returns>Entity object</returns>
		public static vFoodServingType GetEntityObjectV()
		{
			return (vFoodServingType)EntityFactory.GetEntityObject(vFoodServingType.EntityName, GetSourceTypeEnum.View);
		}
