...
{
	public class CallStatusEN : EntityInfoBase
	{
		...
		public override void Initialize(string entityName, string additionalDataKey)
        {
            base.Initialize(entityName, additionalDataKey);
				...
				this.EntityColumns.Add(vCallStatus.ColumnNames.CallStatusID,
                new ColumnInfo() { 
								Name= vCallStatus.ColumnNames.CallStatusID,
								Caption=new i18nText("Common.ENInfo.CallStatus.CallStatusID.Caption", "Call Status"),
				...
				this.EntityColumns.Add(vCallStatus.ColumnNames.CallStatusName,
                new ColumnInfo() { 
								Name= vCallStatus.ColumnNames.CallStatusName,
								Caption=new i18nText("Common.ENInfo.CallStatus.CallStatusName.Caption", "Call Status Name"),
				...
				this.EntityColumns.Add(vCallStatus.ColumnNames.CallStatusTitle,
                new ColumnInfo() { 
								Name= vCallStatus.ColumnNames.CallStatusTitle,
								Caption=new i18nText("Common.ENInfo.CallStatus.CallStatusTitle.Caption", "Call Status Title"),
								DataTypeDotNet=typeof(string), 
								ValidationMaxLength= 50,
								ValidationIsNullable = false, 
								ValidationMinValue = null,
				...
				this.EntityColumns.Add(vCallStatus.ColumnNames.CallStatusIcon,
                new ColumnInfo() { 
								Name= vCallStatus.ColumnNames.CallStatusIcon,
								Caption=new i18nText("Common.ENInfo.CallStatus.CallStatusIcon.Caption", "Call Status Icon"),
								DataTypeDotNet=typeof(string), 
								ValidationMaxLength= 50,
            ...
            this.EntityTitle = "Call Status";
            this.IDFieldName = "CallStatusID";
            this.CodeFieldName = "";
            this.TitleFieldName = "CallStatusTitle";
		...
		public static ICallStatusService GetService(string additionalDataKey = "")
		{
			return (ICallStatusService) EntityFactory.GetEntityServiceByName(vCallStatus.EntityName, additionalDataKey);
		}
		...
		public static CallStatus GetEntityObjectT()
		{
			return (CallStatus)EntityFactory.GetEntityObject(vCallStatus.EntityName, GetSourceTypeEnum.Table);
		}
        ...
        /// </summary>
        /// <returns>Entity object</returns>
		public static vCallStatus GetEntityObjectV()
		{
			return (vCallStatus)EntityFactory.GetEntityObject(vCallStatus.EntityName, GetSourceTypeEnum.View);
		}
