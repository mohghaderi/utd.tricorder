...
{
	public class DailyActivityTypeEN : EntityInfoBase
	{
		...
		public override void Initialize(string entityName, string additionalDataKey)
        {
            base.Initialize(entityName, additionalDataKey);
				...
				this.EntityColumns.Add(vDailyActivityType.ColumnNames.DailyActivityTypeID,
                new ColumnInfo() { 
								Name= vDailyActivityType.ColumnNames.DailyActivityTypeID,
								Caption=new i18nText("Common.ENInfo.DailyActivityType.DailyActivityTypeID.Caption", "Daily Activity Type"),
				...
				this.EntityColumns.Add(vDailyActivityType.ColumnNames.DailyActivityTypeTitle,
                new ColumnInfo() { 
								Name= vDailyActivityType.ColumnNames.DailyActivityTypeTitle,
								Caption=new i18nText("Common.ENInfo.DailyActivityType.DailyActivityTypeTitle.Caption", "Daily Activity Type Title"),
				...
				this.EntityColumns.Add(vDailyActivityType.ColumnNames.HasSumDuration,
                new ColumnInfo() { 
								Name= vDailyActivityType.ColumnNames.HasSumDuration,
								Caption=new i18nText("Common.ENInfo.DailyActivityType.HasSumDuration.Caption", "Has Sum Duration"),
            ...
            this.EntityTitle = "Daily Activity Type";
            this.IDFieldName = "DailyActivityTypeID";
            this.CodeFieldName = "";
            this.TitleFieldName = "DailyActivityTypeTitle";
		...
		public static IDailyActivityTypeService GetService(string additionalDataKey = "")
		{
			return (IDailyActivityTypeService) EntityFactory.GetEntityServiceByName(vDailyActivityType.EntityName, additionalDataKey);
		}
		...
		public static DailyActivityType GetEntityObjectT()
		{
			return (DailyActivityType)EntityFactory.GetEntityObject(vDailyActivityType.EntityName, GetSourceTypeEnum.Table);
		}
        ...
        /// </summary>
        /// <returns>Entity object</returns>
		public static vDailyActivityType GetEntityObjectV()
		{
			return (vDailyActivityType)EntityFactory.GetEntityObject(vDailyActivityType.EntityName, GetSourceTypeEnum.View);
		}
