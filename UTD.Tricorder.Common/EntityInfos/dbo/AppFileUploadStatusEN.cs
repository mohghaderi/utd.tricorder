...
{
	public class AppFileUploadStatusEN : EntityInfoBase
	{
		...
		public override void Initialize(string entityName, string additionalDataKey)
        {
            base.Initialize(entityName, additionalDataKey);
				...
				this.EntityColumns.Add(vAppFileUploadStatus.ColumnNames.AppFileUploadStatusID,
                new ColumnInfo() { 
								Name= vAppFileUploadStatus.ColumnNames.AppFileUploadStatusID,
								Caption=new i18nText("Common.ENInfo.AppFileUploadStatus.AppFileUploadStatusID.Caption", "App File Upload Status"),
				...
				this.EntityColumns.Add(vAppFileUploadStatus.ColumnNames.AppFileUploadStatusTitle,
                new ColumnInfo() { 
								Name= vAppFileUploadStatus.ColumnNames.AppFileUploadStatusTitle,
								Caption=new i18nText("Common.ENInfo.AppFileUploadStatus.AppFileUploadStatusTitle.Caption", "App File Upload Status Title"),
            ...
            this.EntityTitle = "App File Upload Status";
            this.IDFieldName = "AppFileUploadStatusID";
            this.CodeFieldName = "";
            this.TitleFieldName = "AppFileUploadStatusTitle";
		...
		public static IAppFileUploadStatusService GetService(string additionalDataKey = "")
		{
			return (IAppFileUploadStatusService) EntityFactory.GetEntityServiceByName(vAppFileUploadStatus.EntityName, additionalDataKey);
		}
		...
		public static AppFileUploadStatus GetEntityObjectT()
		{
			return (AppFileUploadStatus)EntityFactory.GetEntityObject(vAppFileUploadStatus.EntityName, GetSourceTypeEnum.Table);
		}
        ...
        /// </summary>
        /// <returns>Entity object</returns>
		public static vAppFileUploadStatus GetEntityObjectV()
		{
			return (vAppFileUploadStatus)EntityFactory.GetEntityObject(vAppFileUploadStatus.EntityName, GetSourceTypeEnum.View);
		}
