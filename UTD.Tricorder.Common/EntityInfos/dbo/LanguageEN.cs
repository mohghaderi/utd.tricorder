...
{
	public class LanguageEN : EntityInfoBase
	{
		...
		public override void Initialize(string entityName, string additionalDataKey)
        {
            base.Initialize(entityName, additionalDataKey);
				...
				this.EntityColumns.Add(vLanguage.ColumnNames.LanguageID,
                new ColumnInfo() { 
								Name= vLanguage.ColumnNames.LanguageID,
								Caption=new i18nText("Common.ENInfo.Language.LanguageID.Caption", "Language"),
				...
				this.EntityColumns.Add(vLanguage.ColumnNames.LanguageCode,
                new ColumnInfo() { 
								Name= vLanguage.ColumnNames.LanguageCode,
								Caption=new i18nText("Common.ENInfo.Language.LanguageCode.Caption", "Language Code"),
				...
				this.EntityColumns.Add(vLanguage.ColumnNames.LanguageName,
                new ColumnInfo() { 
								Name= vLanguage.ColumnNames.LanguageName,
								Caption=new i18nText("Common.ENInfo.Language.LanguageName.Caption", "Language Name"),
								DataTypeDotNet=typeof(string), 
            ...
            this.EntityTitle = "Language";
            this.IDFieldName = "LanguageID";
            this.CodeFieldName = "LanguageCode";
            this.TitleFieldName = "LanguageName";
		...
		public static ILanguageService GetService(string additionalDataKey = "")
		{
			return (ILanguageService) EntityFactory.GetEntityServiceByName(vLanguage.EntityName, additionalDataKey);
		}
		...
		public static Language GetEntityObjectT()
		{
			return (Language)EntityFactory.GetEntityObject(vLanguage.EntityName, GetSourceTypeEnum.Table);
		}
        ...
        /// </summary>
        /// <returns>Entity object</returns>
		public static vLanguage GetEntityObjectV()
		{
			return (vLanguage)EntityFactory.GetEntityObject(vLanguage.EntityName, GetSourceTypeEnum.View);
		}
