...

{
	...
	public partial class AppExceptionLog : EntityObjectBase, Framework.Common.Logging.IAppExceptionLog
	{
		...
		public AppExceptionLog(
			long appexceptionlogid, 
			string message, 
			DateTime insertdate)
			: this()
		{
			_appexceptionlogid = appexceptionlogid;
			_message = message;
			_source = String.Empty;
			_userid = null;
			_insertdate = insertdate;
			_classtype = String.Empty;
			_stacktrace = String.Empty;
			_target = String.Empty;
			_ipaddress = String.Empty;
			_url = String.Empty;
			_datainformation = String.Empty;
		}
